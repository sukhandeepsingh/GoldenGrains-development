          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                If you're not satisfied with your purchase, we accept returns
                within 30 days of delivery. To initiate a return, please email
                us at support@goldengrains.com with your order number and a
                brief explanation of why you're returning the item.
              </p>
            </div>
          )}
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@goldengrains.com, or by calling us at (696) 969-6969
                between the hours of 6am and 9pm IST, Monday through Friday.
              </p>
            </div>
          )}
        </div>
