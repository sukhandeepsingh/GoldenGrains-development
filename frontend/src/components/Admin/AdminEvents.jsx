...
import { adminAllEvents, deleteEvent } from "../../redux/actions/event";
...
const AdminEvents = () => {
  const { adminEvents, isLoading } = useSelector((state) => state.events);
  ...
  useEffect(() => {
    dispatch(adminAllEvents());
  }, [dispatch]);

  const handleDelete = async (id) => {
    await axios
      .delete(`${server}/event/admin-delete-event/${id}`, { withCredentials: true })
      .then((res) => {
