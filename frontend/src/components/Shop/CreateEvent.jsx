      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            placeholder="Enter event product's original price..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            placeholder="Enter event product's discounted price..."
          />
        </div>
        <br />
        <div>
          <label className="pb-2">
            Stock (quantity available) <span className="text-red-600">*</span>
          </label>
          <input
            type="number"
            name="stock"
            ...
            placeholder="Enter event product's stock..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            min={today}
            placeholder="Enter event product's start date..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            min={minEndDate}
            placeholder="Enter event product's end date..."
          />
        </div>
        <br />
        <div>
